...
<script>
    ...
    export default {
        ...
        methods: {
            remove() {
                this.resetError();
                ObserveService.observe({article_list_id: this.entity.id})
                    .then(() => {
...
<i18n>
    {
        "en": {
            "confirmation": "Are you sure you would like to remove this list from your observed lists?",
            "label_yes": "Yes, remove list",
            "toast_removed": "The list has been removed."
        },
        "de": {
            "confirmation": "Möchtest du diese Liste wirklich aus deinen beobachteten Listen entfernen?",
