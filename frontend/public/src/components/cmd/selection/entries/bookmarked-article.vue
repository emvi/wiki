...
<script>
    ...
    export default {
        ...
        methods: {
            remove() {
                this.resetError();
                BookmarkService.bookmark({article_id: this.entity.id})
                    .then(() => {
...
<i18n>
    {
        "en": {
            "confirmation": "Are you sure you would like to remove this article from your bookmarks?",
            "label_yes": "Yes, remove article",
            "toast_removed": "The article has been removed."
        },
        "de": {
            "confirmation": "Möchtest du diesen Artikel wirklich aus deinen Lesezeichen entfernen?",
